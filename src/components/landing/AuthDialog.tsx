...
export const AuthDialog = ({
  ...
  return <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-extrabold">Get Started with Rabbit Hole Analytics
              ...
              <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4">
                ...
                field
                      ...
                      <div className="relative">
                        ...
                        {passwordsMatch && password && <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                            <Check size={16} />
                          </div>}
                      </div>
                      <FormMessage />
                ...
                field
                      ...
                      <div className="relative">
                        ...
                        {passwordsMatch && confirmPassword && <div className="absolute right-3 top-1/2 -translate-y-1/2 text-green-500">
                            <Check size={16} />
                          </div>}
                      </div>
                      <FormMessage />
